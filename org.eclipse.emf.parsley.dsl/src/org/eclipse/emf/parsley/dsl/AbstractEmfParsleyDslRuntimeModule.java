...
import org.eclipse.emf.parsley.dsl.formatting2.EmfParsleyDslFormatter;
import org.eclipse.emf.parsley.dsl.jvmmodel.EmfParsleyDslJvmModelInferrer;
import org.eclipse.emf.parsley.dsl.parser.antlr.EmfParsleyDslAntlrTokenFileProvider;
import org.eclipse.emf.parsley.dsl.parser.antlr.EmfParsleyDslParser;
import org.eclipse.emf.parsley.dsl.parser.antlr.internal.InternalEmfParsleyDslLexer;
import org.eclipse.emf.parsley.dsl.scoping.EmfParsleyDslScopeProvider;
import org.eclipse.emf.parsley.dsl.serializer.EmfParsleyDslSemanticSequencer;
import org.eclipse.emf.parsley.dsl.serializer.EmfParsleyDslSyntacticSequencer;
import org.eclipse.emf.parsley.dsl.services.EmfParsleyDslGrammarAccess;
import org.eclipse.emf.parsley.dsl.validation.EmfParsleyDslValidator;
...
/**
 * Manual modifications go to {@link EmfParsleyDslRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractEmfParsleyDslRuntimeModule extends DefaultXbaseWithAnnotationsRuntimeModule {
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return EmfParsleyDslGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return EmfParsleyDslSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return EmfParsleyDslSyntacticSequencer.class;
	}
	...
	public Class<? extends IParser> bindIParser() {
		return EmfParsleyDslParser.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return EmfParsleyDslAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalEmfParsleyDslLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalEmfParsleyDslLexer> provideInternalEmfParsleyDslLexer() {
		return LexerProvider.create(InternalEmfParsleyDslLexer.class);
	}
	...
	public void configureRuntimeLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalEmfParsleyDslLexer.class);
	}
	...
	public Class<? extends EmfParsleyDslValidator> bindEmfParsleyDslValidator() {
		return EmfParsleyDslValidator.class;
	}
	...
	public Class<? extends IFormatter2> bindIFormatter2() {
		return EmfParsleyDslFormatter.class;
	}
	...
	public Class<? extends IJvmModelInferrer> bindIJvmModelInferrer() {
		return EmfParsleyDslJvmModelInferrer.class;
	}
