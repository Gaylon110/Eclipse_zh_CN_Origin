...
public class EmfParsleyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_FieldSpecification_SemicolonKeyword_5_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_FieldSpecification_SemicolonKeyword_5_q = new TokenAlias(false, true, grammarAccess.getFieldSpecificationAccess().getSemicolonKeyword_5());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_FieldSpecification_SemicolonKeyword_5_q.equals(syntax))
				emit_FieldSpecification_SemicolonKeyword_5_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     right=XExpression (ambiguity) (rule end)
	 */
	protected void emit_FieldSpecification_SemicolonKeyword_5_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
