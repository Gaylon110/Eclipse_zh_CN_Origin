 ...
 * @generated
 */
public class ProposalCreatorImpl extends WithFieldsImpl implements ProposalCreator
{
  /**
   ...
   * @ordered
   */
  protected EList<FeatureAssociatedExpression> proposalsSpecifications;
   ...
   * @generated
   */
  public EList<FeatureAssociatedExpression> getProposalsSpecifications()
  {
    if (proposalsSpecifications == null)
    {
      proposalsSpecifications = new EObjectContainmentEList<FeatureAssociatedExpression>(FeatureAssociatedExpression.class, this, ModelPackage.PROPOSAL_CREATOR__PROPOSALS_SPECIFICATIONS);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ModelPackage.PROPOSAL_CREATOR__PROPOSALS_SPECIFICATIONS:
        ...
        getProposalsSpecifications().addAll((Collection<? extends FeatureAssociatedExpression>)newValue);
        return;
    }
