...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.facet.widgets.table.metamodel.v0_2_0.table.SourceColumn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceColumnItemProvider
	 ...
	 * @generated
	 */
	public SourceColumnItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceColumn_isHidden_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SourceColumn_isHidden_feature", "_UI_SourceColumn_type"),
				 TablePackage.Literals.SOURCE_COLUMN__IS_HIDDEN,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceColumn"));
	}
	...
	public String getText(Object object) {
		SourceColumn sourceColumn = (SourceColumn)object;
		return getString("_UI_SourceColumn_type") + " " + sourceColumn.getWidth();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SourceColumn.class)) {
