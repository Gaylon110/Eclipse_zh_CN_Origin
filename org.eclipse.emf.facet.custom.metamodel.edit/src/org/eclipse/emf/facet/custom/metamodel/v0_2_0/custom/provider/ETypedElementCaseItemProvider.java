...
public class ETypedElementCaseItemProvider
	...
	public String getText(Object object) {
		String result;
		if (object instanceof ETypedElementCase) {
			ETypedElementCase typedEltCase = (ETypedElementCase) object;
			final ETypedElement case1 = typedEltCase.getCase();
			result = "Case ";
			if (case1 == null){
				result += "<eObject node>";
			} else {
				result += case1.getName();
			}
		} else {
			result = getString("_UI_ETypedElementCase_type");
		}
		return result;
	}
