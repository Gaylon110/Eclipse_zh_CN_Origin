...
public class EClassCustomizationItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EClassCustomization")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String result; 
		if (object instanceof EClassCustomization) {
			final EClassCustomization eClassCustom = (EClassCustomization) object;
			final EClass extendedMetaclass = eClassCustom.getExtendedMetaclass();
			final String extdMetaclassName = extendedMetaclass.getName();
			result = NLS.bind(Messages.EClassCustomizationItemProvider_Custom_of, extdMetaclassName);
		} else {
			final String label = ((EClassCustomization) object).getName();
			result = label == null || label.length() == 0 ? getString("_UI_EClassCustomization_type") : //$NON-NLS-1$
					getString("_UI_EClassCustomization_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
		}
		return result;
	}
