...
public class CopyHandler extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (activePart != null) {
			...
			if (widgetProvider != null) {
				widgetProvider.getTableWidget().copySelectionToClipboard();
			}
		}
		return null;
	}
	...
	public boolean isEnabled() {
		...
		final ITableWidgetProvider widgetProvider = HandlerUtils
				.getActiveTableWidgetProvider();
		if (widgetProvider != null) {
			isEnabled = widgetProvider.getTableWidget().isCellSelected();
		}
		return isEnabled;
	}
}
