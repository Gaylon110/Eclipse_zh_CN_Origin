...
/**
 * This is the action bar contributor for the ModelCellEditor model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ModelCellEditorActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			CelleditorsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			CelleditorsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
		public boolean isEnabled() {
			return ModelCellEditorActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
		}

		@Override
		public void run() {
			if (ModelCellEditorActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
				Viewer viewer = ((IViewerProvider) ModelCellEditorActionBarContributor.this.activeEditorPart)
						.getViewer();
				if (viewer != null) {
					viewer.refresh();
				}
	 ...
	 * @generated
	 */
	public ModelCellEditorActionBarContributor() {
	...
	public void contributeToToolBar(final IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("modelcelleditor-settings"));
		toolBarManager.add(new Separator("modelcelleditor-additions"));
	}
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				CelleditorsEditorPlugin.INSTANCE.getString("_UI_ModelCellEditorEditor_menu"),
				"org.eclipse.emf.facet.widgets.celleditors.modelCellEditorMenuID");
		...
		this.createChildMenuManager = new MenuManager(
				CelleditorsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", this.createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		this.createSiblingMenuManager = new MenuManager(
				CelleditorsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
