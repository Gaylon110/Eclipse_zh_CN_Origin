...
public class HasShortTitle implements IJavaQuery2<Book, Boolean> {

	public static final int SHORT_TITLE_THRESHOLD = 10;
	...
	public Boolean evaluate(final Book book, final IParameterValueList2 parameterValues, final IFacetManager facetManager)
		...
		return Boolean.valueOf(new TitleLength().evaluate(book, null, facetManager).intValue() < HasShortTitle.SHORT_TITLE_THRESHOLD);
	}
}
