...
public class IsProlific implements IJavaQuery2<Writer, Boolean> {

	public static final int PROLIFICNESS_THRESHOLD = 9;
	...
	public Boolean evaluate(final Writer writer, final IParameterValueList2 parameterValues, final IFacetManager facetManager)
		...
		return Boolean.valueOf(nBooksWritten.intValue() >= IsProlific.PROLIFICNESS_THRESHOLD);
	}
}
