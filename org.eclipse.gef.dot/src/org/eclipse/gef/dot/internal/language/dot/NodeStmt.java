 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gef.dot.internal.language.dot.NodeStmt#getNode <em>Node</em>}</li>
 *   <li>{@link org.eclipse.gef.dot.internal.language.dot.NodeStmt#getAttrLists <em>Attr Lists</em>}</li>
 * </ul>
 *
 * @see org.eclipse.gef.dot.internal.language.dot.DotPackage#getNodeStmt()
 * @model
 * @generated
 */
public interface NodeStmt extends Stmt
{
   ...
   * @see #setNode(NodeId)
   * @see org.eclipse.gef.dot.internal.language.dot.DotPackage#getNodeStmt_Node()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.gef.dot.internal.language.dot.NodeStmt#getNode <em>Node</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.gef.dot.internal.language.dot.DotPackage#getNodeStmt_AttrLists()
   * @model containment="true"
   * @generated
   */
