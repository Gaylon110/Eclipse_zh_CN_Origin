...
public class DotStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.gef.dot.internal.language.DotRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/gef/dot/internal/language/Dot")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/gef/dot/internal/language/Dot", org.eclipse.gef.dot.internal.language.dot.DotPackage.eINSTANCE);
	}
