...
public class ShapeAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected ShapeSwitch<Adapter> modelSwitch =
    new ShapeSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePolygonBasedShape(PolygonBasedShape object)
      {
        return createPolygonBasedShapeAdapter();
      }
      @Override
      public Adapter caseRecordBasedShape(RecordBasedShape object)
      {
        return createRecordBasedShapeAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.shape.Shape <em>Shape</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.shape.PolygonBasedShape <em>Polygon Based Shape</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.shape.RecordBasedShape <em>Record Based Shape</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
