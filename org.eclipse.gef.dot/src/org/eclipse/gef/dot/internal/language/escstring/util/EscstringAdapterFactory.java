...
public class EscstringAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected EscstringSwitch<Adapter> modelSwitch =
    new EscstringSwitch<Adapter>()
    {
      @Override
      public Adapter caseEscString(EscString object)
      {
        return createEscStringAdapter();
      }
      @Override
      public Adapter caseJustifiedText(JustifiedText object)
      {
        return createJustifiedTextAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.escstring.EscString <em>Esc String</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.escstring.JustifiedText <em>Justified Text</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
