...
public class RectAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected RectSwitch<Adapter> modelSwitch =
    new RectSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.rect.Rect <em>Rect</em>}'.
   * <!-- begin-user-doc -->
