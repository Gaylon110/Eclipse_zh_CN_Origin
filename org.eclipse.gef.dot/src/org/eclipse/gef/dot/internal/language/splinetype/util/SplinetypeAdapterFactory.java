...
public class SplinetypeAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected SplinetypeSwitch<Adapter> modelSwitch =
    new SplinetypeSwitch<Adapter>()
    {
      @Override
      ...
      @Override
      public Adapter caseSpline(Spline object)
      {
        return createSplineAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.splinetype.SplineType <em>Spline Type</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.splinetype.Spline <em>Spline</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
