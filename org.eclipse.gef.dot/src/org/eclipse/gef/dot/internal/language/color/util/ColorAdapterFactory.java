...
public class ColorAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected ColorSwitch<Adapter> modelSwitch =
    new ColorSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseHSVColor(HSVColor object)
      {
        return createHSVColorAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.color.Color <em>Color</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.color.RGBColor <em>RGB Color</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.color.HSVColor <em>HSV Color</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.gef.dot.internal.language.color.StringColor <em>String Color</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
