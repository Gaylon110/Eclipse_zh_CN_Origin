...
public class AggregateSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AggregatePackage.AGGREGATE: {
				Aggregate aggregate = (Aggregate)theEObject;
				T result = caseAggregate(aggregate);
				if (result == null) result = caseCustomization(aggregate);
				if (result == null) result = caseFacetSet(aggregate);
				if (result == null) result = caseEPackage(aggregate);
				if (result == null) result = caseDocumentedElement(aggregate);
				if (result == null) result = caseENamedElement(aggregate);
				if (result == null) result = caseEModelElement(aggregate);
